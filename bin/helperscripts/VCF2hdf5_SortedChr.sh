...
python ${HASEDIR}/tools/VCF2hdf5_fixed.py -flag probes  -data ../${SAVE_DIR}/${SNPs_INFO} -out ../${SAVE_DIR} -study_name ${STUDYNAME}
python ${HASEDIR}/tools/VCF2hdf5_fixed.py -flag individuals  -data ../${SAVE_DIR}/${SUBJECT_ID_FILE} -out ../${SAVE_DIR} -study_name ${STUDYNAME}
